 ...
 */
class Grupo extends \AdminBundle\Entity\Grupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Grupo' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Grupo' . "\0" . 'nombre', '' . "\0" . 'AdminBundle\\Entity\\Grupo' . "\0" . 'slug');
        }
