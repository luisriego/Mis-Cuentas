 ...
 */
class FPago extends \AdminBundle\Entity\FPago implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\FPago' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\FPago' . "\0" . 'nombre', '' . "\0" . 'AdminBundle\\Entity\\FPago' . "\0" . 'slug', '' . "\0" . 'AdminBundle\\Entity\\FPago' . "\0" . 'notas', '' . "\0" . 'AdminBundle\\Entity\\FPago' . "\0" . 'imagen', '' . "\0" . 'AdminBundle\\Entity\\FPago' . "\0" . 'vto');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FPago $proxy) {
